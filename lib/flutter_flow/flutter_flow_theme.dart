...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF07A8FE);
  late Color secondary = const Color(0xFFCAF0FC);
  late Color tertiary = const Color(0xFFFFDEAC);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF3193C9);
  late Color secondary = const Color(0xFF5A8FA2);
  late Color tertiary = const Color(0xFFA8773B);
