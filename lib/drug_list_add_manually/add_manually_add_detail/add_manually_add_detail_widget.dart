...
import 'add_manually_add_detail_model.dart';
export 'add_manually_add_detail_model.dart';

class AddManuallyAddDetailWidget extends StatefulWidget {
  const AddManuallyAddDetailWidget({super.key});

  static String routeName = 'AddManually_AddDetail';
  static String routePath = '/addManuallyAddDetail';

  @override
  State<AddManuallyAddDetailWidget> createState() =>
      _AddManuallyAddDetailWidgetState();
}

class _AddManuallyAddDetailWidgetState
    extends State<AddManuallyAddDetailWidget> {
  late AddManuallyAddDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddManuallyAddDetailModel());
