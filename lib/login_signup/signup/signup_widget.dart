              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: '영문, 숫자 조합 8~15자리 이내로 입력해 주세요.',
                      hintStyle:
                          FlutterFlowTheme.of(context).labelMedium.override(
                                font: GoogleFonts.inter(
                                  fontWeight: FlutterFlowTheme.of(context)
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    autofocus: false,
                    obscureText: !_model.passwordCheckVisibility,
                    decoration: InputDecoration(
                      isDense: true,
                      labelStyle:
                          FlutterFlowTheme.of(context).labelMedium.override(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (_model.passwordTextController.text !=
                          _model.passwordCheckTextController.text) {
                      ...
                      await UserRecord.collection.doc(user.uid).update({
                        ...createUserRecordData(
                          ...
                          slot5OriginRef: '비어있음',
                          slot6OriginRef: '비어있음',
                          slot1IntakeTime: '비어있음',
                          slot2IntakeTime: '비어있음',
                          slot3IntakeTime: '비어있음',
                          slot4IntakeTime: '비어있음',
                          slot5IntakeTime: '비어있음',
                          slot6IntakeTime: '비어있음',
                          sex: '-',
                          pregnancy: false,
                          breastfeeding: false,
                          height: 0.0,
                        ...
                        ...mapToFirestore(
                          {
                            ...
                            'time_1': FieldValue.serverTimestamp(),
                            'time_2': FieldValue.serverTimestamp(),
                            'time_3': FieldValue.serverTimestamp(),
                            'time_4': FieldValue.serverTimestamp(),
                          },
                        ),
                      });
