...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    _model.loginIdTextController ??= TextEditingController();
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      final user = await authManager.signInWithEmail(
                        context,
                        _model.loginIdTextController.text,
                      ...
                      context.pushNamedAuth(
                          IntakeScheduleWidget.routeName, context.mounted);
                    },
                    text: '로그인',
