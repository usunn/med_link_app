...
import 'edit_myinfo_model.dart';
export 'edit_myinfo_model.dart';

class EditMyinfoWidget extends StatefulWidget {
  const EditMyinfoWidget({super.key});

  static String routeName = 'Edit_Myinfo';
  static String routePath = '/editMyinfo';
...
class _EditMyinfoWidgetState extends State<EditMyinfoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.resulta = await queryUserRecordOnce(
      ...
      _model.birth = _model.resulta?.birthDate;
      safeSetState(() {});
    });
  }
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model.dropDownValueController ??=
                              ...
                              _model.dropDownValue ??= listViewUserRecord?.sex,
                            ),
                            options: ['남자', '여자'],
                            onChanged: (val) =>
                              ...
                              children: [
                                ...
                                Switch.adaptive(
                                  value: _model.switchValue2 ??=
                                      listViewUserRecord!.breastfeeding,
                                  onChanged: (newValue) async {
                                    safeSetState(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await listViewUserRecord!.reference
                                ...
                                birthDate: _model.birth,
                                pregnancy: _model.switchValue1,
                                breastfeeding: _model.switchValue2,
                              ));
                              context.safePop();
                            },
                            text: '저장',
